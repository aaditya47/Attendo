...
public class TodoDTO {
	...
	@JsonCreator
	public TodoDTO(@JsonProperty("StudentId") StudentDetails StudentId,@JsonProperty("Subject") String Subject, @JsonProperty("Ddate")Date Ddate, @JsonProperty("TId")TeacherDetails TId,@JsonProperty("Attendedhours")String Attendedhours, @JsonProperty("Noofhours")String Noofhours){
	...
	public String toString() {
		return "Attendance [id=" + StudentId + " Subject=" + Subject + " Ddate=" + Ddate + " TId=" + TId + " Noofhours=" + Noofhours+ " + Attendedhours="+Attendedhours+"]";
	}
