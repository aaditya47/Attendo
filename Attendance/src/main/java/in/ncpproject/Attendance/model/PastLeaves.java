...
public class PastLeaves{
	...
	@JsonCreator
	public PastLeaves(@JsonProperty("StudentId") StudentDetails StudentId, @JsonProperty("TeacherId") TeacherDetails TeacherId, @JsonProperty("DOS") Date DOS, @JsonProperty("DOE") Date DOE,@JsonProperty("Reason") String Reason, @JsonProperty("Approval") String Approval,@JsonProperty("CertLink") String CertLink){
	...
	public String toString() {
		return "PastLeaveData [id=" + StudentId + " TId=" + TeacherId + " DOS=" + DOS + " DOE=" + DOE + " Reason=" +Reason+ " Approval=" +Approval+ " CertLink=" +CertLink+ "]";
	}
