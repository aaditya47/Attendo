...
public class TeacherDetails {
	...
	@JsonCreator
	public TeacherDetails(@JsonProperty("TeacherId")String TeacherId,@JsonProperty("Name") String Name, @JsonProperty("Phone") String Phone,@JsonProperty("Email")String Email,@JsonProperty("Dept")String Dept,@JsonProperty("Desg")String Desg){
