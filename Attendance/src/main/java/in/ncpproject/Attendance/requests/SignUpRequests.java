...
public class SignUpRequests {
	...
	@JsonCreator
	public SignUpRequests(@JsonProperty("StudentId") String StudentId, @JsonProperty("Name") String Name,
			@JsonProperty("Phone") String Phone, @JsonProperty("Email") String Email, @JsonProperty("Dept") String Dept,
			@JsonProperty("Cgpa") String Cgpa, @JsonProperty("Password") String Password) {
