...
public class PastLeavesRequests {
	...
	@JsonCreator
	public PastLeavesRequests(@JsonProperty("StudentId") String StudentId, @JsonProperty("TeacherId") String TeacherId, @JsonProperty("DOS") Date DOS, @JsonProperty("DOE") Date DOE,@JsonProperty("Reason") String Reason, @JsonProperty("Approval") String Approval,@JsonProperty("CertLink") String CertLink){
