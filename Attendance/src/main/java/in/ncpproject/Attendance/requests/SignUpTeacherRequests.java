...
public class SignUpTeacherRequests {
	...
	@JsonCreator
	public SignUpTeacherRequests(@JsonProperty("TeacherId") String TeacherId, @JsonProperty("Name") String Name,
			@JsonProperty("Phone") String Phone, @JsonProperty("Email") String Email, @JsonProperty("Dept") String Dept,
			@JsonProperty("Desg") String Desg, @JsonProperty("Password") String Password) {
